...
class PantryDetailError extends StatelessWidget {
  final PantryDetailState state;
  final String pantryId;

  const PantryDetailError({super.key, required this.state, required this.pantryId});
    ...
    return Column(
      children: [
        MyButton(
          ...
          onPressed: () {
            context.read<PantryDetailBloc>().add(GetPantryDetailEvent(pantryId: pantryId));
          },
